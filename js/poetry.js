...
function updateDisplay(verseName) {
    console.log("Selected verse from inside the function: " + verseName);
    // STEP 4: Declare and initialize URL to point to text file(s)
    const url = `${verseName}.txt`; // Construct URL dynamically based on verse name
